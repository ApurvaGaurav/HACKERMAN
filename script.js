...
let start = () => {
	...
	let p2 = () => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				resolve(`Searching ${person_name}'s useranme....PLZZ WAIT....`)
			}, 4000);
	...
	let p4 = () => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				resolve(`connectiong to ${person_name} facebook and other social media applications...PLZZ WAIT.....`)
			}, 7000);
	...
	let p5 = () => {
		return new Promise((resolve, reject) => {
			setTimeout(() => {
				resolve(`Successfully hacked ${person_name} account and personal details !!!`)
			}, 10000);
